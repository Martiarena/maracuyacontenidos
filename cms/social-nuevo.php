...
if($proceso == "Registrar"){
	...
	$orden				= $_POST['orden'];
	$estado				= $_POST['estado'];
	$insertarBanner = "INSERT INTO social_links(type, links, orden, estado)VALUE('$type', '$links', '$orden', '$estado')";
                            ...
                            <form class="fcms" name="fcms" method="post" action="">
                            	<div class="form-int">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                            <input name="links" type="text" id="link" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        	<div class="btn-group">
                                                ...
                                                <button class="btn btn-blue" type="button" name="boton" onClick="javascript:Validar();" /><i class="fa fa-chevron-circle-right"></i> Registrar Red Sociales</button>
											</div>

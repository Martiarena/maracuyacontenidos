...
if($proceso == "Actualizar"){
	...
	$actualizarUsuarios = "UPDATE usuarios SET cod_usuario='$cod_usuario', nombres='$nombres', email='$email', usuario='$usuario', clave='$clave', estado='$estado' WHERE cod_usuario='$cod_usuario'";
                            	...
                            	<div class="form-int">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
											<div class="custom-input">
												<input <?php if (!(strcmp($estado,"A"))) {echo "checked=\"checked\"";} ?> type="radio" name="estado" id="activo" value="A"><label for="activo">Activo</label>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        	<div class="custom-input">
			                                    <input name="chk" type="checkbox" id="chkbx-1" value="s"> <label for="chkbx-1" style="padding-left:20px;"> Enviar cambios al correo electr&oacute;nico (de no verlo revise su carpeta de spam).</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="separador-20"></div>

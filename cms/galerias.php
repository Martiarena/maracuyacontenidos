	...
	<div id="wrapper">
		...
		<div id="content" class="clearfix">
			...
			<div class="breadcrumbs">
				<i class="fa fa-home"></i> Portafolio <i class="fa fa-caret-right"></i> Galer&iacute;as
			</div>
					...
					<div class="widget grid12">
						<div class="widget-header">
							<div class="widget-title">
								<i class="fa fa-th"></i> <strong>Lista de Galer&iacute;as</strong>
							</div>
						</div> <!-- /widget-header -->
						<div class="widget-content">
							...
							<form name="fcms" method="post" action="">
                            	<table class="text-center" width="100%" border="1" id="portafolio">
                                	<thead>
                                    	<tr>
                                        	<th width="25%" scope="col">Trabajo</th>
									...
									<?php
                                        $consultarPor = "SELECT cp.cod_categoria, cp.categoria, p.* FROM categorias as cp, portafolio as p WHERE p.cod_categoria=cp.cod_categoria AND p.type='I' ORDER BY p.orden";
                                        ...
                                        while($filaPor = mysqli_fetch_array($resultadoPor)){
											...
											//Número de fotos
											$consultaFoto = "SELECT * FROM galeria_portafolio WHERE cod_portafolio=$xCodigo";
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="images/portafolio/<?php echo $xImagen; ?>" width="148" height="98" /></td>
                                        <td><?php echo $xOrden; ?></td>
                                        <td><a class="boton-nuevo" href="galerias-nuevo.php?cod_portafolio=<?php echo $xCodigo; ?>"><i class="fa fa-search"></i></a></td>
                                    </tr>
                                    <?php }else{ ?><?php } ?>
									<?php
                                        }

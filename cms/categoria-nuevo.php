...
if($proceso == "Registrar"){
	$categoria			= htmlspecialchars(utf8_encode($_POST['categoria']));
	$orden				= $_POST['orden'];
	$estado				= $_POST['estado'];
	$insertarCategoria = "INSERT INTO categorias(categoria, orden, estado)VALUE('$categoria', '$orden', '$estado')";
	$resultadoInsertar = mysqli_query($enlaces,$insertarCategoria);
	$mensaje = "<div class='alert alert-success' role='alert'>
					<button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button>
					<p><strong>Nota:</strong> La categor&iacute;a se registr&oacute; con exitosamente. <a href='categorias.php'>Ir a categorias</a></p>
                </div>";
}
?>
<!DOCTYPE html>
...
<head>
	...
	<script>
		function Validar(){
			...
			document.fcms.action = "categoria-nuevo.php";

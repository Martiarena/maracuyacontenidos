                ...
                <div class="fluid">
					<div class="widget grid12">
						...
						<div class="widget-content">
	                        ...
	                        <a class="btn btn-blue" href="usuario-nuevo.php"><i class="fa fa-plus" aria-hidden="true"></i> Añadir nuevo</a>
                            <hr>
                        	<form name="fcms" method="post" action="">
								<table class="text-center" width="100%" border="1">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if($xCodigo!="1"){?><strong>[<?php if($xEstado=="A"){ echo "Activo";}elseif($xEstado=="I"){ echo "Inactivo";} ?>]</strong><?php }?></td>
                                        <td><?php if($xCodigo!="1"){?><a class="boton-eliminar" href="usuario-delete.php?cod_usuario=<?php echo $xCodigo; ?>"><i class="fa fa-trash" aria-hidden="true"></i></a><?php }?></td>
                                        <td><?php if($xCodigo!="1"){?><a class="boton-editar" href="usuario-edit.php?cod_usuario=<?php echo $xCodigo; ?>"><i class="fa fa-pencil-square" aria-hidden="true"></i></a><?php }?></td>
                                        <td>
                                        	<div class="custom-input">
                                                <?php if($xCodigo!="1"){?><input class="hidden-xs" type="checkbox" id="chkbx-<?php echo $xCodigo; ?>" name="chk<?php echo $xCodigo; ?>" /><label for="chkbx-<?php echo $xCodigo; ?>"></label><?php } ?>
											</div>
										</td>
									</tr>
									<?php

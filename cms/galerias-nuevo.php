...
$consultaFotos = "SELECT * FROM galeria_portafolio WHERE cod_portafolio='$cod_portafolio'";
...
if($proceso == "Registrar"){
	...
	$imagen				= $_POST['imagen'];
	$estado				= $_POST['estado'];
	$insertarGaleria = "INSERT INTO galeria_portafolio(cod_portafolio, imagen, estado)VALUE('$cod_portafolio', '$imagen', '$estado')";
	$resultadoInsertar = mysqli_query($enlaces,$insertarGaleria);
	$mensaje = "<div class='alert alert-success' role='alert'>
					<button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button>
					<p><strong>Nota:</strong> Se a&ntilde;adi&oacute; la imagen exitosamente. <a href='galerias.php'>Ir a Galerias</a></p>
                </div>";
	...
	<div id="wrapper">
		...
		<div id="content" class="clearfix">
			...
			<div class="wrp clearfix">
            	<?php $page="galerias"; include("includes/menu-portafolio.php"); ?>
                <div class="fluid">
					<div class="widget grid12">
						...
						<div class="widget-content">
							<div class='alert alert-info' role='alert'>
								<button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button>
								<p><strong>Nota:</strong> A&ntilde;ada fotos al trabajo que seleccion&oacute;. Si ha puesto el tipo de trabajo como v&iacute;deo (V) no se mostrar&aacute; la galer&iacute;a.</p>
			                </div>
                            <?php echo $mensaje; ?>
	                        <div class="form-int">
                            	<form class="fcms" name="fcms" method="post" action="">
									...
									<div class="row">
    	                            	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        	<label>A&ntilde;adir imagen: * <br><span>(1200px x 738px)</span></label>
                                        </div>
							...
							<div id="listagaleria">
								<ul>
                                    ...
                                    ?>
                                    <li class="thumbnail"><a href="galeria-delete.php?cod_galeria_portafolio=<?php echo $xCodigoGal; ?>&cod_portafolio=<?php echo $xCodportafolio; ?>"><img src="../img/portafolio/galeria/<?php echo $xFoto; ?>" width="150" height="100"></a></li>
                                    <?php
                                        }
                                    ?>
								</ul>

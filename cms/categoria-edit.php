...
if($proceso == ""){
	$consultaCategoria = "SELECT * FROM categorias WHERE cod_categoria='$cod_categoria'";
	...
	$categoria = utf8_encode($filaCat['categoria']);
	$orden	 = $filaCat['orden'];
...
if($proceso=="Actualizar"){	
	...
	$orden					= $_POST['orden'];
	$estado					= $_POST['estado'];
	$actualizarCategoria	= "UPDATE categorias SET cod_categoria='$cod_categoria', categoria='$categoria', orden='$orden', estado='$estado' WHERE cod_categoria='$cod_categoria'";
...
<head>
	...
	<script>
		function Validar(){
			...
			document.fcms.action = "categoria-edit.php";
	...
	<div id="wrapper">
		...
		<div id="content" class="clearfix">
			...
			<div class="breadcrumbs">
				<i class="fa fa-home"></i> Portafolio <i class="fa fa-caret-right"></i> Categor&iacute;as <i class="fa fa-caret-right"></i> Editar Categor&iacute;a
			</div>
                            	...
                            	<div class="form-int">
									...
									<div class="row">
                                    	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="btn-group">
                                            	<a href="categorias.php" class="btn btn-pink"><i class="fa fa-times"></i> Cancelar</a>
